...
int main() {
    ...
    Marquees rwMarq(&canvas, &xmasColors, 2, rwColors, 25, RIGHT,
                    canvas.getHeight());
    rwMarq.setName("RWMarq");
    animator.addTimed(&rwMarq, 30000);

    Marquees rgMarq(&canvas, &xmasColors, 2, rgColors, 25, RIGHT,
                    canvas.getHeight());
    rgMarq.setName("RGMarq");
    animator.addTimed(&rgMarq, 30000);

    LinesFill lfu(&canvas, &xmasColors, 5, rgbwgColors, UP, 1);
    lfu.setName("LFU");
    lfu.setGap(6);
    animator.addTimed(&lfu, 15000);

    LinesFill lfd(&canvas, &xmasColors, 5, rgbwgColors, DOWN, 1);
    lfd.setName("LFD");
    lfd.setGap(7);
    animator.addTimed(&lfd, 15000);

    Spiral sp1(&canvas, &xmasColors, 0, 0, 4, rgbwColors, 10, 25);
    sp1.setName("Spiral1");
    animator.addTimed(&sp1, 10000);

    Spiral sp2(&canvas, &xmasColors, 0, 0, 1, rwColors, 10, 25);
    sp2.setName("Spiral2");
    animator.addTimed(&sp2, 10000);

    Spiral sp3(&canvas, &xmasColors, 0, 0, 2, rgColors, 10, 25);
    sp3.setName("Spiral3");
    animator.addTimed(&sp3, 10000);

    Spiral spired(&canvas, &xmasColors, 20, 0, 1, rColors, 10, 25);
    spired.setName("SpiralRed");
    spired.setDirection(Direction::UP);

    Spiral spigreen(&canvas, &xmasColors, 0, canvas.getHeight() - 1, 1,
                    gColors, 10, 25);
    spigreen.setName("SpiralGreen");
    spigreen.setDirection(Direction::DOWN);
    MultiAnimation ma1(&canvas, &xmasColors);
    ma1.setName("RGSpirals");
    ma1.add(&spired);
    ma1.add(&spigreen);
    animator.addTimed(&ma1, 10000);

    Spiral spired1(&canvas, &xmasColors, 0, 0, 1, rColors, 10, 25);
    spired1.setName("SpRed1");
    spired1.setDirection(Direction::UP);

    Spiral spired2(&canvas, &xmasColors, 40, 0, 1, rColors, 10, 30);
    spired2.setName("SpRed2");
    spired2.setDirection(Direction::UP);
    spired2.setClearPrev(false);

    MultiAnimation ma2(&canvas, &xmasColors);
    ...
    ColorBars cb1(&canvas, &xmasColors, 20, 2);
    cb1.setName("CB1");
    ...
    FadingBars fb2(&canvas, &xmasColors, 10, 4);
    fb2.setName("FB2");
    animator.addTimed(&fb2, 10000);

    FadingBars fb3(&canvas, &xmasColors, 4, 2);
    fb3.setName("FB3");
    animator.addTimed(&fb3, 10000);

    FadingBars fb4(&canvas, &xmasColors, 4, 6);
    fb4.setName("FB4");
    animator.addTimed(&fb4, 10000);

    RotatingColumns rc1(&canvas, &xmasColors, 2, rgColors, 25);
    rc1.setName("RC1");
    animator.addTimed(&rc1, 10000);

    RotatingColumns rc2(&canvas, &xmasColors, 4, rgbwColors, 10);
    rc2.setName("RC2");
    animator.addTimed(&rc2, 10000);

    RotatingRows rr1(&canvas, &xmasColors, 2, rgColors, 4);
    rr1.setName("RR1");
    animator.addTimed(&rr1, 10000);

    RotatingRows rr2(&canvas, &xmasColors, 4, rgbwColors, 5);
    rr2.setName("RR2");
    animator.addTimed(&rr2, 10000);

    RotRandColumns rrc1(&canvas, &xmasColors, 2);
    rrc1.setName("RRC1");
    animator.addTimed(&rrc1, 10000);

    RotRandColumns rrc2(&canvas, &xmasColors, 4);
    rrc2.setName("RRC2");
    animator.addTimed(&rrc2, 10000);

    RotRandRows rrr1(&canvas, &xmasColors, 4);
    rrr1.setName("RRR1");
    animator.addTimed(&rrr1, 10000);

    RotRandRows rrr2(&canvas, &xmasColors, 2);
    rrr2.setName("RRR2");
    ...
    ScrollText st3(&canvas, &font, "JOYEUX NOEL", 55, 0, xmasColors[2]);
    ScrollText st4(&canvas, &font, "CHAG SAMEACH", 40, -10, xmasColors[3]);
    ScrollText st5(&canvas, &font, "FELIZ NAVIDAD", 25, -30, xmasColors[4]);
    ScrollText st6(&canvas, &font, "SEASON'S GREETINGS", 10, -20, xmasColors[5]);
    sts.add(&st1);
    sts.add(&st2);
    sts.add(&st3);
    sts.add(&st4);
